$(function() {
  ...
  /*  var $form = $('#modal-form');
    ...
    $("#add").click(function(){
        ...
        var tr = '<tr>' +
            '<td><input type="hidden" name="ngid"/><input class="col-xs-12 col-sm-12" maxlength="40" name="orgname" oninput="calculate()" autocomplete="off"/></td>' +
    ...
    $("#uploadify").uploadify({
        ...
        'uploader': ctx + '/dashboard/service/archive2/uploadorg;JSESSIONID='+sessionid,
    ...
    if(jsonValue != ''){
        ...
        for(var i=0; i < obj.length; i++){
            ...
            var tr = '<tr>' +
                '<td><input type="hidden" name="ngid" value="'+ obj[i].id+'"/><input class="col-xs-12 col-sm-12" maxlength="15" name="orgname" autocomplete="off" onkeyup="calculate()" value="'+ obj[i].orgname+'"/></td>' +
    ...
    if(jsonOrg != ''){
        ...
        for(var i=0; i < obj.length; i++){
            ...
            if(valueOpinion =='' || valueOpinion == null || valueOpinion == undefined || valueOpinion == '0'){
                tr+= '<a data-toggle="modal" href="'+ctx+'/dashboard/service/archive2/'+obj[i].id+'/visitopinion" data-target="#myModal">' +
                    '<span class="label label-inverse">设置评价</span></a>'+
                    '</div>' +
                    '</td>' +
                    '</tr>';
            }else{
                tr+= '<a data-toggle="modal" href="'+ctx+'/dashboard/service/archive2/'+obj[i].id+'/viewopinion" data-target="#myModal">' +
